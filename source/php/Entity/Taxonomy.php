...
use SchoolsManager\Helper\Field;
use WP_Error;
...
class Taxonomy implements TermInterface
{
    ...
    public function registerTaxonomy(): string
    {
        $labels = array(
            ...
            'search_items'      => sprintf(__('Search %s', 'api-schools-manager'), $this->namePlural),
            'all_items'         => sprintf(__('All %s', 'api-schools-manager'), $this->namePlural),
            'parent_item'       => sprintf(__('Parent %s:', 'api-schools-manager'), $this->nameSingular),
            'parent_item_colon' => sprintf(__('Parent %s:', 'api-schools-manager'), $this->nameSingular) . ':',
            'edit_item'         => sprintf(__('Edit %s', 'api-schools-manager'), $this->nameSingular),
            'update_item'       => sprintf(__('Update %s', 'api-schools-manager'), $this->nameSingular),
            'add_new_item'      => sprintf(__('Add New %s', 'api-schools-manager'), $this->nameSingular),
            'new_item_name'     => sprintf(__('New %s Name', 'api-schools-manager'), $this->nameSingular),
